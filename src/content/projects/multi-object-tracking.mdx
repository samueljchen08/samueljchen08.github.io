...
links:
  - label: 'repo'
    href: 'https://github.com/samueljchen08/Multi-Object-Tracking'
  - label: 'paper'
    href: 'https://drive.google.com/file/d/14I8We1yRNw1d1kzCVHLzmc5P-jsfh__H/view'
    primary: true
stack: ['Python', 'PyTorch', 'XGBoost', 'OpenCV']
headline:
  value: '0.219 ft'
...
The write-up is in [the paper](https://drive.google.com/file/d/14I8We1yRNw1d1kzCVHLzmc5P-jsfh__H/view); the code is a single Colab notebook in the repository.
