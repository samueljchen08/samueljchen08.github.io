...
answer: 'No. Adding ball features made every model slightly worse — and a hand-tuned Kalman filter with no training data at all beat every network trained on 138,000 rows.'
period: 'April 2026'
repo: 'https://github.com/samueljchen08/Multi-Object-Tracking'
stack: ['Python', 'PyTorch', 'YOLO11', 'XGBoost', 'OpenCV']
measured:
  value: '0.219 ft'
  source: 'Notebook §10 · full test set'
  href: 'https://github.com/samueljchen08/Multi-Object-Tracking/blob/main/sports_tracking_colab.ipynb'
disclosure: 'The ball detector is the weak link and the result rests on it: YOLO11 found the ball in only 10.9% of frames, so the fair comparison runs on 16,009 rows rather than 138,357. A better detector could change the answer, and nothing here rules that out.'
order: 3
---
