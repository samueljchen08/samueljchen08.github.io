...
links:
  - label: 'repo'
    href: 'https://github.com/samueljchen08/agentic-commerce-lab'
    primary: true
  - label: 'live report'
    href: 'https://samueljchen08.github.io/agentic-commerce-lab/'
stack: ['Python', 'Bayesian inference', 'Causal inference', 'LLM APIs', 'pytest']
headline:
  value: '−$188,718'
